...
class DeviceStateLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testDeviceStateLang()
    {
        ...
        $db_lang_1 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => DeviceState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => DeviceState::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => DeviceState::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => DeviceState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => DeviceState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(DeviceStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => DeviceState::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = DeviceStateLang::find($db_lang_1->id);
            // Then
    ...
    public function testDeviceState()
    {
        ...
        // Get lang of record
            // When
            $record_1 = DeviceState::find($db_morph_1->id);
            $lang_1   = DeviceStateLang::find($db_lang_1->id);
            $lang_4   = DeviceStateLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = DeviceState::find($db_morph_2->id);
