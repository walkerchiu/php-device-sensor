...
class DataTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testData()
    {
        ...
        $db_data_1 = factory(Data::class)->create(['device_id' => $db_device->id, 'register_id' => $db_register->id]);
        $db_data_2 = factory(Data::class)->create(['device_id' => $db_device->id, 'register_id' => $db_register->id]);
        $db_data_3 = factory(Data::class)->create(['device_id' => $db_device->id, 'register_id' => $db_register->id]);
